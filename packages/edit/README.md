...
Authoring component for the **Fill In The Blank** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-fill-blank-edit
```
...
```ts
import { Edit } from '@tailor-cms/ce-fill-blank-edit';
```
