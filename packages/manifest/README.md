...
Shared element definition for the **Fill In The Blank** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-fill-blank-manifest
```
...
```ts
import manifest, { type ElementData } from '@tailor-cms/ce-fill-blank-manifest';

manifest.type;       // 'FILL_BLANK'
